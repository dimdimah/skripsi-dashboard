...
import { StaggerContainer, StaggerItem, HoverScale } from '@/components/landing/motion-wrapper'

export const metadata: Metadata = {
  title: 'SITRACK — Telusuri Jejak Alumni Amikom',
  description:
    'Platform resmi tracer study Universitas Amikom Surakarta. Lacak karir, kontribusi, dan perkembangan lulusan STMIK Amikom Surakarta. Data untuk akreditasi dan peningkatan kualitas pendidikan.',
  openGraph: {
    title: 'SITRACK — Sistem Informasi Track Record Alumni',
    description:
      'Platform resmi tracer study Universitas Amikom Surakarta. Lacak karir, kontribusi, dan perkembangan lulusan.',
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-amikom-pearl">
      ...
      {/* ═══════════════ GLOBAL NAV ═══════════════ */}
      <nav className="sticky top-0 z-50 h-14 bg-white/80 backdrop-blur-sm border-b border-amikom-hairline">
        <div className="mx-auto flex h-full max-w-[1440px] items-center justify-between px-6 lg:px-12">
          <div className="flex items-center gap-5">
            <Link href="/" className="text-amikom-ink text-sm font-bold tracking-[-0.01em] hover:text-amikom-purple transition-colors">
              SITRACK
            </Link>
            <div className="hidden md:flex items-center gap-5">
              <SmoothScrollLink href="#cara-kerja" className="text-amikom-ink/60 text-sm hover:text-amikom-purple transition-colors">Cara Kerja</SmoothScrollLink>
              <SmoothScrollLink href="#fitur" className="text-amikom-ink/60 text-sm hover:text-amikom-purple transition-colors">Fitur</SmoothScrollLink>
              <SmoothScrollLink href="#analytics" className="text-amikom-ink/60 text-sm hover:text-amikom-purple transition-colors">Analytics</SmoothScrollLink>
            </div>
          </div>
      ...
      {/* ═══════════════ HERO ═══════════════ */}
      <section className="relative overflow-hidden bg-amikom-pearl">
        {/* Background orbs */}
        ...
        <div className="relative mx-auto max-w-[980px] px-6 pt-[100px] pb-[80px] text-center lg:px-12 lg:pt-[120px]">
          ...
          <h1 className="font-display text-[36px] sm:text-[44px] md:text-[52px] lg:text-[60px] font-semibold leading-[1.05] tracking-[-0.03em] text-amikom-ink animate-fade-in-up" style={{ animationDelay: '0.05s' }}>
            Telusuri Jejak<br className="sm:hidden" /> Alumni Amikom.
          </h1>
          <p className="mt-5 md:mt-6 text-[18px] sm:text-[20px] md:text-[22px] font-normal leading-[1.5] text-amikom-ink-muted-48 max-w-[640px] mx-auto animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="mt-8 md:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
            ...
            <SmoothScrollLink
              href="#cara-kerja"
              className="inline-flex items-center rounded-full border border-amikom-hairline bg-white px-7 py-3 text-[16px] font-normal text-amikom-ink transition-all hover:border-amikom-purple/30 hover:text-amikom-purple active:scale-[0.98]"
            >
          ...
          {/* Trust indicators */}
          <div className="mt-12 flex flex-wrap items-center justify-center gap-8 text-sm text-amikom-ink-muted-48 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
      ...
      {/* ═══════════════ CARA KERJA ═══════════════ */}
      <section id="cara-kerja" className="bg-white scroll-mt-20">
        <ScrollReveal>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div
                key={item.step}
                className="relative rounded-2xl border border-amikom-hairline bg-amikom-pearl p-8 transition-all hover:border-amikom-purple/20 hover:shadow-sm"
              ...
              >
                ...
                <h3 className="mt-5 text-[18px] font-semibold leading-[1.24] tracking-[-0.02em] text-amikom-ink">
                  {item.title}
                </h3>
                <p className="mt-2 text-[15px] font-normal leading-[1.6] text-amikom-ink-muted-48">
                  {item.desc}
                </p>
              </div>
            ))}
      ...
      {/* ═══════════════ FEATURES ═══════════════ */}
      <section id="fitur" className="bg-amikom-pearl scroll-mt-20">
        <ScrollReveal>
          <div className="mx-auto max-w-[1280px] px-6 py-[80px] lg:px-12">
            <div className="text-center mb-14">
              ...
              <p className="mt-3 text-[18px] font-normal leading-[1.5] text-amikom-ink-muted-48 max-w-[520px] mx-auto">
                Semua yang alumni butuhkan dalam satu platform terintegrasi.
              </p>
            </div>
            ...
            {[
              {
                title: 'Track Record',
                desc: 'Kelola riwayat karir dan pengalaman kerja setelah lulus. Update kapan saja untuk data yang selalu akurat.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 00.75-1.661V8.706c0-1.081-.768-2.015-1.837-2.175a48.114 48.114 0 00-3.413-.387m4.5 8.006c-.194.165-.42.295-.673.38A23.978 23.978 0 0112 15.75c-2.648 0-5.195-.429-7.577-1.22a2.016 2.016 0 01-.673-.38m0 0A2.18 2.18 0 013 12.489V8.706c0-1.081.768-2.015 1.837-2.175a48.111 48.111 0 013.413-.387m7.5 0V5.25A2.25 2.25 0 0013.5 3h-3a2.25 2.25 0 00-2.25 2.25v.894m7.5 0a48.667 48.667 0 00-7.5 0M12 12.75h.008v.008H12v-.008z" />
                  </svg>
              ...
              {
                title: 'Tracer Study',
                desc: 'Isi kuesioner tracer study untuk mendokumentasikan perjalanan karir setelah lulus dari Amikom.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              },
              {
                ...
                desc: 'Dapatkan rekomendasi lowongan kerja yang sesuai dengan skill, lokasi, dan preferensimu — didukung TF-IDF.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M20.893 13.393l-1.135-1.135a2.252 2.252 0 01-.421-.585l-1.08-2.16a.414.414 0 00-.663-.107.827.827 0 01-.812.21l-1.273-.363a.89.89 0 00-.738.135l-.275.223a2.25 2.25 0 01-1.597.398l-.952-.19a2.25 2.25 0 00-1.597.398l-.952-.19a2.25 2.25 0 00-1.597.398l-.275.223a.89.89 0 01-.738.135l-1.273-.363a.414.414 0 00-.663.107.827.827 0 01-.812-.21l-1.08 2.16a2.252 2.252 0 01-.421.585l-1.135 1.135a2.25 2.25 0 000 3.182l1.135 1.135c.18.18.332.386.45.614l1.08 2.16a.414.414 0 00.663.107.827.827 0 01.812-.21l1.273.363a.89.89 0 00.738-.135l.275-.223a2.25 2.25 0 011.597-.398l.952.19a2.25 2.25 0 001.597-.398l.952.19a2.25 2.25 0 001.597-.398l.275-.223a.89.89 0 01.738-.135l1.273.363a.414.414 0 00.663-.107.827.827 0 01.812.21l1.08-2.16a2.25 2.25 0 00.45-.614l1.135-1.135a2.25 2.25 0 000-3.182z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 15.75a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5z" />
              ...
              },
              {
                ...
                desc: 'Lihat dampak data yang kamu isi — employment rate alumni, distribusi gaji, dan kesesuaian bidang studi.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              {
                title: 'Data Terpusat',
                desc: 'Semua data karir, kuesioner tracer study, dan lowongan kerja tersimpan rapi di satu akun. Akses kapan saja.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <StaggerItem key={feature.title}>
                <HoverScale>
                  <div className="rounded-2xl border border-amikom-hairline bg-white p-7 transition-all hover:border-amikom-purple/20 hover:shadow-sm"
                  >
                    <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-amikom-purple/5 text-amikom-purple">
                      {feature.icon}
                    </div>
                    <h3 className="mt-5 text-[17px] font-semibold leading-[1.24] tracking-[-0.02em] text-amikom-ink">
                      {feature.title}
                    </h3>
                    <p className="mt-2 text-[15px] font-normal leading-[1.6] text-amikom-ink-muted-48">
                      {feature.desc}
      ...
      {/* ═══════════════ ANALYTICS HIGHLIGHT ═══════════════ */}
      <section id="analytics" className="bg-white relative overflow-hidden scroll-mt-20">
        ...
        <ScrollReveal>
          <div className="mx-auto max-w-[980px] px-6 py-[80px] text-center lg:px-12">
            ...
            <p className="mt-4 text-[18px] font-normal leading-[1.5] text-amikom-ink-muted-48 max-w-[560px] mx-auto">
              Kuesioner terstruktur menghasilkan data berharga untuk akreditasi dan peningkatan kualitas pendidikan.
            </p>
            <div className="mt-10 grid gap-5 sm:grid-cols-3">
              {[
                { label: 'Employment Rate', target: 87, suffix: '%', desc: 'Alumni bekerja setelah lulus', color: 'text-amikom-purple' },
                { label: 'Response Rate', target: 92, suffix: '%', desc: 'Rata-rata pengisian kuesioner', color: 'text-amikom-ink' },
                { label: 'Field Match', target: 78, suffix: '%', desc: 'Pekerjaan sesuai bidang studi', color: 'text-amikom-purple' },
              ].map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-2xl border border-amikom-hairline bg-amikom-pearl px-6 py-8 text-center transition-all hover:border-amikom-purple/20"
                >
                  <p className="text-[10px] font-mono uppercase tracking-[0.25em] text-amikom-ink-muted-48">
                    {stat.label}
                  </p>
                  ...
                  <p className="mt-1 text-sm text-amikom-ink-muted-48">
                    {stat.desc}
                  </p>
              </div>
            ))}
      ...
      <section className="bg-amikom-pearl">
        <ScrollReveal>
          <div className="mx-auto max-w-[980px] px-6 py-[80px] text-center lg:px-12">
            <div className="rounded-3xl bg-gradient-to-br from-amikom-purple to-amikom-purple-hover p-10 md:p-14 text-center">
        ...
        <ScrollReveal delay={100}>
          ...
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <p className="mt-3 text-[15px] leading-[1.6] text-amikom-ink-muted-48">
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2">
                ...
                <li><SmoothScrollLink href="#fitur" className="text-[15px] leading-[1.6] text-amikom-ink-muted-48 hover:text-amikom-purple transition-colors">Fitur</SmoothScrollLink></li>
                <li><SmoothScrollLink href="#analytics" className="text-[15px] leading-[1.6] text-amikom-ink-muted-48 hover:text-amikom-purple transition-colors">Analytics</SmoothScrollLink></li>
              </ul>
            </div>
